...
##
## ``` sh
## sudo IS_DEBUG=true ./skel.sh labwc
## ```
##
## run
##
## ``` sh
## sudo REF_MAIN_RUN=test IS_DEBUG=true ./skel.sh labwc
## ```
##
...
args_var_init () {
	...
	DEFAULT_BUILD_RESPIN="labwc"
	REF_BUILD_RESPIN="${REF_BUILD_RESPIN:=$DEFAULT_BUILD_RESPIN}"
	REF_BUILD_RESPIN_OPTION_LIST="labwc xfce lxqt kde-plasma gnome-shell mate cinnamon"
...
model_var_init () {
	...
	REF_ISO_PROFILE_REPO_GIT_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-labwc.git"

	#REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-labwc/archive/refs/heads/main.zip"
	REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/ezarcher-live-build-config-template-labwc/archive/refs/heads/main.tar.gz"


	REF_ISO_PROFILE_REPO_ARCHIVE_FILE_NAME="main.tar.gz"
	REF_ISO_PROFILE_REPO_ARCHIVE_EXTRACT_DIR_NAME="ezarcher-live-build-config-template-labwc-main"
...
msg_usage_body_main () {
	...
	util_error_echo "Example  : sudo ./${REF_CMD_FILE_NAME}"
	util_error_echo
	util_error_echo "Example  : sudo ./${REF_CMD_FILE_NAME} labwc"
	util_error_echo
...
msg_usage_body_locale () {
	...
	util_error_echo
	util_error_echo "Example  : sudo REF_BUILD_LOCALE=zh_tw ./${REF_CMD_FILE_NAME} labwc"
	util_error_echo
...
msg_usage_body_arch () {
	...
	util_error_echo
	util_error_echo "Example  : sudo REF_BUILD_ARCH=amd64 ./${REF_CMD_FILE_NAME} labwc"
	util_error_echo
